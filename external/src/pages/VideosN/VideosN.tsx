        ...
        <div className="nav-header bg-transparent shadow-none border-0">
            <div className="nav-top w-100">
                ...
                <div className="links">
                    ...
                    <Link to="/login" className="header-btn d-none d-lg-block fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 ">Tv Shows</Link>
                    <Link to="/login" className="header-btn d-none d-lg-block fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 ">Movies</Link>
                    <Link to="/login" className="header-btn d-none d-lg-block fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 ">New & Popular</Link>
                    {/* <Link to="/login" className="header-btn d-none d-lg-block fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 ">My List</Link> */}
                </div>
