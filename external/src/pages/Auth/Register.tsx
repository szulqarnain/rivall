                ...
                style={{background:'rgb(16 16 16 / 28%)'}}>
                    <div className="card shadow-none border-0 ms-auto me-auto login-card" style={{background:'transparent'}}>
                        <div className="card-body rounded-0 text-left" style={{background:'transparent'}}>
                            <h2 className="fw-700 display1-size display2-md-size mb-3 text-white">Register</h2>
                            <form>
                                ...
                                <div className="form-group icon-input mb-1">
                                    {/* <input type="Password" className="mt-1 text-white style2-input ps-5 form-control font-xss ls-3" placeholder="Confirm Password" style={{background:'transparent'}}/> */}
                                    <select className='w-full pd-[60px] pl-[45px] pr-[50px] h-[58px] bg-transparent text-white font-semibold' style={{border:'2px solid white',borderRadius:'8px'}}>
                            ...
                            <div className="col-sm-12 p-0 text-left">
                                <div className="form-group mb-1"><a href="/login" className="form-control text-center mt-[10px] style-input text-dark fw-600 bg-white border-0 p-0 ">Register</a></div>
                                <h6 className="text-white font-xsss fw-500 mt-0 mb-0 lh-32 text-center">If you have an account <a href="/login" className="fw-700 ms-1">Login</a></h6>
                            </div>
