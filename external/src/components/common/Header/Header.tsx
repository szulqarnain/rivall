    ...
    <nav className={`navigation scroll-bar ${navClass}`}>
        <div className="container ps-0 pe-0">
            <div className="nav-content">
                ...
                <div className="nav-wrap mt-4 bg_white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2">
                            <div className="nav-caption fw-600 font-xssss text-grey-500"><span> </span> Features</div>
                            <ul className="mb-3">
                                <li><Link to="/store" className="nav-content-bttn open-font"><i className="font-xl text-current feather-shopping-cart me-3"></i><span>Store</span>
                                {/* <span className="circle-count bg-warning mt-1">584</span> */}
                                </Link></li>    
                                <li><Link to="/music" className="nav-content-bttn open-font"><i className="font-xl text-current feather-music me-3"></i><span>Music</span>
                                {/* <span className="circle-count bg-warning mt-1">584</span> */}
                                </Link></li>
                                <li><Link to="/announcement" className="nav-content-bttn open-font"><i className="font-xl text-current feather-bell me-3"></i>
                                <span>Announcement </span>
                                {/* <span className="circle-count bg-warning mt-1">584</span> */}
                                </Link></li>
                                <li><Link to="/videos" className="nav-content-bttn open-font"><i className="font-xl text-current feather-youtube me-3"></i><span>Videos</span>
                                {/* <span className="circle-count bg-warning mt-1">584</span> */}
                                </Link></li>                     
                            </ul>
                </div>
                ...
                <div className="nav-wrap bg_white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1">
                    ...
                    <ul className="mb-1">
                        ...
                        <li><Link to="/profile" className="nav-content-bttn open-font h-auto pt-2 pb-2"><i className="font-sm feather-user me-3 text-grey-500"></i><span>My Profile</span></Link></li>
                        ...
                        <li><Link to="/defaultsettings" className="nav-content-bttn open-font h-auto pt-2 pb-2"><i className="font-sm feather-shield me-3 text-grey-500"></i><span>Secuirty & Privacy</span></Link></li>
                        <li><Link to="/defaultsettings" className="nav-content-bttn open-font h-auto pt-2 pb-2"><i className="font-sm feather-settings me-3 text-grey-500"></i><span>General Settings</span></Link></li>
                    </ul>
                </div>
            </div>
        </div>
