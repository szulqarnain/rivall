                    ...
                    <div className="nav-content">
                        ...
                        <div className="nav-wrap bg_white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1">
                            ...
                            <ul className="mb-1">
                                ...
                                <li><Link to="/defaultanalytics" className="nav-content-bttn open-font h-auto pt-2 pb-2"><i className="font-sm feather-pie-chart me-3 text-grey-500"></i><span>Password</span></Link></li>
                            </ul>
                        </div>
